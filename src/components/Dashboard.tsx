...
export const Dashboard: React.FC<DashboardProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full mb-6">
      {/* Stat 1: Target Path */}
      <div className="bg-zinc-900/60 border border-zinc-800 rounded-xl p-4 flex items-center justify-between backdrop-blur-md">
        <div>
          <span className="text-[11px] font-medium uppercase tracking-wider text-zinc-400">Current Path Mode</span>
      ...
      <div className="bg-zinc-900/60 border border-zinc-800 rounded-xl p-4 flex items-center justify-between backdrop-blur-md">
        <div>
          <span className="text-[11px] font-medium uppercase tracking-wider text-zinc-400">Gatekeeper Verification</span>
      ...
      <div className="bg-zinc-900/60 border border-zinc-800 rounded-xl p-4 flex items-center justify-between backdrop-blur-md">
        <div>
          <span className="text-[11px] font-medium uppercase tracking-wider text-zinc-400">Empathy Engine</span>
          <h4 className="text-sm font-semibold text-zinc-100 mt-0.5">
      ...
      <div className="bg-zinc-900/60 border border-zinc-800 rounded-xl p-4 flex items-center justify-between backdrop-blur-md">
        <div>
          <span className="text-[11px] font-medium uppercase tracking-wider text-zinc-400">Target Skills</span>
